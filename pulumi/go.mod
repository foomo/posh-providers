...
require (
	...
	github.com/foomo/posh-providers/azure v0.49.2
	github.com/foomo/posh-providers/google v0.49.2
...
require (
	...
	github.com/foomo/posh-providers/kubernetes v0.49.2 // indirect
