...
func TestConfig(t *testing.T) {
	...
	require.NoError(t, reflector.AddGoComments("github.com/foomo/posh-providers/foomo/dockprox", "./"))
	schema := reflector.Reflect(&dockprox.Config{})
	schema.ID = "https://raw.githubusercontent.com/foomo/posh-providers/main/foomo/dockprox/config.schema.json"
