...
func NewCommand(l log.Logger, cache cache.Cache) *Zeus {
	return &Zeus{
		l:     l,
		name:  "zeus",
...
func (c *Zeus) GetName() string {
	return c.name
}

func (c *Zeus) GetDescription() string {
	return "run zeus on target"
}

func (c *Zeus) Complete(ctx context.Context, r *readline.Readline, d prompt.Document) []prompt.Suggest {
	switch {
...
func (c *Zeus) Validate(ctx context.Context, r *readline.Readline) error {
	switch {
	case r.Args().LenLt(1):
...
func (c *Zeus) Execute(ctx context.Context, r *readline.Readline) error {
...
func (c *Zeus) completePaths(ctx context.Context) []prompt.Suggest {
	return suggests.List(c.paths(ctx))
}

//nolint:forcetypeassert
func (c *Zeus) paths(ctx context.Context) []string {
