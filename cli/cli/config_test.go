...
func TestConfig(t *testing.T) {
	...
	require.NoError(t, reflector.AddGoComments("github.com/foomo/posh-providers/cli/cli", "./"))
	schema := reflector.Reflect(&cli.Config{})
	schema.ID = "https://raw.githubusercontent.com/foomo/posh-providers/main/cli/cli/config.schema.json"
