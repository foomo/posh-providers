...
func TestConfig(t *testing.T) {
	...
	require.NoError(t, reflector.AddGoComments("github.com/foomo/posh-providers/galaxy/tempo", "./"))
	schema := reflector.Reflect(&tempo.Config{})
	schema.ID = "https://raw.githubusercontent.com/foomo/posh-providers/main/galaxy/tempo/config.schema.json"
